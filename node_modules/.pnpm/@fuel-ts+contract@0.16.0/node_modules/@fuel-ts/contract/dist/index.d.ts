...
import { CallResult, TransactionResponse, TransactionResult, ScriptTransactionRequest, CoinQuantity, Provider, CoinQuantityLike, CreateTransactionRequestLike } from '@fuel-ts/providers';
...
declare class FunctionInvocationResult<T = any> extends InvocationResult<T> {
    ...
    constructor(funcScopes: InvocationScopeLike | Array<InvocationScopeLike>, transactionResponse: TransactionResponse, transactionResult: TransactionResult<any>, isMultiCall: boolean);
    static build<T>(funcScope: InvocationScopeLike | Array<InvocationScopeLike>, transactionResponse: TransactionResponse, isMultiCall: boolean): Promise<FunctionInvocationResult<T>>;
}
